                                        ...
                                        <table class="table table-sm m-0 table-striped table-bordered" id="arf-header-table">
                                            <tbody class="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select onchange="preSelectOfficeLocation(this.value)" name="arf_dept" id="arf_dept" class="form-select form-select-sm" aria-label="Default" required>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <input class="form-control arf-form-control" type="number" name="arf_emp_id" required />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
